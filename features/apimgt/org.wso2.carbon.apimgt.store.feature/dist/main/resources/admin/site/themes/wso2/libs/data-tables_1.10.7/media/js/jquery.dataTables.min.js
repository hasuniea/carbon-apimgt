...
(function (Ea, Q, k) {
  var P = function P(h) {
    ...
    function Fa(a, b) {
      var c = _m.defaults.column,
          ...
          c = h.extend({}, _m.models.oColumn, c, {
      ...
      a.aoColumns.push(c);
      c = a.aoPreSearchCols;
      c[e] = h.extend({}, _m.models.oSearch, c[e]);
      ka(a, e, h(b).data());
    }
    ...
    function ka(a, b, c) {
      ...
      c !== k && null !== c && (fb(c), H(_m.defaults.column, c), c.mDataProp !== k && !c.mData && (c.mData = c.mDataProp), c.sType && (b._sManualType = c.sType), c.className && !c.sClass && (c.sClass = c.className), h.extend(b, c), E(b, c, "sWidth", "sWidthOrig"), c.iDataSort !== k && (b.aDataSort = [c.iDataSort]), E(b, c, "aDataSort"));
    ...
    function Ha(a) {
      ...
      for (f = b.length; d < f; d++) {
        if (l = b[d], n = [], !l.sType && l._sManualType) l.sType = l._sManualType;else if (!l.sType) {
          g = 0;
    ...
    function na(a, b, c, e) {
      var d = [],
        ...
        if ("string" === typeof a) {
          ...
          a = function a(_a) {
        if (c === k || c === j) g = o[j], i = h.trim(_a.innerHTML), g && g._bAttrSrc ? (S(g.mData._)(e, i), q(g.mData.sort, _a), q(g.mData.type, _a), q(g.mData.filter, _a)) : l ? (g._setter || (g._setter = S(g.mData)), g._setter(e, i)) : e[j] = i;
        j++;
      };
    ...
    function ea(a, b, c) {
      ...
      if (b) {
        ...
        for (d = g.length; e < d; e++) {
          if (a = g[e].nTr) for (; f = a.firstChild;) {
            a.removeChild(f);
          }
          f = 0;
    ...
    function mb(a) {
      ...
      for (var f = a.sDom.split(""), g, j, i, o, l, q, n = 0; n < f.length; n++) {
        ...
        if ("<" == j) {
          ...
          d.append(i);
          d = h(i);
        } else if (">" == j) d = d.parent();else if ("l" == j && e.bPaginate && e.bLengthChange) g = nb(a);else if ("f" == j && e.bFilter) g = ob(a);else if ("r" == j && e.bProcessing) g = pb(a);else if ("t" == j) g = qb(a);else if ("i" == j && e.bInfo) g = rb(a);else if ("p" == j && e.bPaginate) g = sb(a);else if (0 !== _m.ext.feature.length) {
          i = _m.ext.feature;
          q = 0;
    ...
    function xb(a) {
      for (var b = _m.ext.search, c = a.aiDisplay, e, d, f = 0, g = b.length; f < g; f++) {
    ...
    function wb(a, b, c, e, d, f) {
      if ("" !== b) for (var g = a.aiDisplay, e = Qa(b, e, d, f), d = g.length - 1; 0 <= d; d--) {
    ...
    function Ga(a) {
      ...
      if (!k && !f && !d && j == aa(a) && j == i.length) for (n = 0; n < j; n++) {
        ...
        if (a.aoData.length) for (n = 0; n < e.length; n++) {
        ...
        if (f) {
          for (n = g = 0; n < e.length; n++) {
            m = c[e[n]], d = h(i[n]).outerWidth(), g += null === m.sWidthOrig ? d : parseInt(m.sWidth, 10) + d - h(i[n]).width();
          }
      ...
      o && (b.style.width = s(o));
      if ((o || f) && !a._reszEvt) b = function b() {
    ...
    function Gb(a, b) {
      for (var c, e = -1, d = -1, f = 0, g = a.aoData.length; f < g; f++) {
        c = x(a, f, b, "display") + "", c = c.replace($b, ""), c.length > e && (e = c.length, d = f);
      }
      ...
      for (a = 0; a < o.length; a++) {
        ...
        for (c = f.length; b < c; b++) {
          g = f[b], j = d[g].sType || "string", o[a]._idx === k && (o[a]._idx = h.inArray(o[a][1], d[g].asSorting)), e.push({
            ...
            index: o[a]._idx,
            type: j,
            formatter: _m.ext.type.order[j + "-pre"]
          });
        }
      }
    ...
    function Ib(a, b) {
      var c = a.aoColumns[b],
          e = _m.ext.order[c.sSortDataType],
          d;
      e && (d = e.call(a.oInstance, a, b, $(a, b)));

      for (var f, g = _m.ext.type.order[c.sType + "-pre"], j = 0, i = a.aoData.length; j < i; j++) {
    ...
    function I(a, b, c, e) {
      ...
      if (b) Ea.console && console.log && console.log(c);else if (b = _m.ext, b = b.sErrMode || b.errMode, w(a, null, "error", [a, e, c]), "alert" == b) alert(c);else {
    ...
    function Nb(a) {
      return function () {
        var b = [za(this[_m.ext.iApiIndex])].concat(Array.prototype.slice.call(arguments));
        return _m.ext.internal[a].apply(this, b);
      };
    }
    ...
    _m = function m(a) {
      ...
      this.api = function (a) {
        return a ? new _t(za(this[u.iApiIndex])) : new _t(this);
      };
      ...
      this.each(function () {
        ...
        if ("table" != this.nodeName.toLowerCase()) I(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);else {
          ...
          if (null === i || "" === i) this.id = i = "DataTables_Table_" + _m.ext._unique++;
          var p = h.extend(!0, {}, _m.models.oSettings, {
          ...
          i = p.oClasses;
          d.bJQueryUI ? (h.extend(i, _m.ext.oJUIClasses, d.oClasses), d.sDom === l.sDom && "lfrtip" === l.sDom && (p.sDom = '<"H"lfr>t<"F"ip>'), p.renderer) ? h.isPlainObject(p.renderer) && !p.renderer.header && (p.renderer.header = "jqueryui") : p.renderer = "jqueryui" : h.extend(i, _m.ext.classes, d.oClasses);
          q.addClass(i.sTable);
          ...
          if (d.aaData) for (g = 0; g < d.aaData.length; g++) {
            K(p, d.aaData[g]);
    ...
    _t = function t(a, b) {
      ...
      if (h.isArray(a)) for (var d = 0, f = a.length; d < f; d++) {
        e(a[d]);
      } else e(a);
      this.context = Na(c);
    ...
    _t.prototype = {
      ...
      filter: function filter(a) {
        var b = [];
        if (y.filter) b = y.filter.call(this, a, this);else for (var c = 0, e = this.length; c < e; c++) {
      ...
      iterator: function iterator(a, b, c, e) {
        ...
        return d.length || e ? (a = new _t(l, a ? d.concat.apply([], d) : d), b = a.selector, b.rows = m.rows, b.cols = m.cols, b.opts = m.opts, a) : this;
      },
      ...
      map: function map(a) {
        var b = [];
        if (y.map) b = y.map.call(this, a, this);else for (var c = 0, e = this.length; c < e; c++) {
      ...
      unique: function unique() {
        return new _t(this.context, Na(this));
      },
      unshift: y.unshift
    };
    ...
    _t.extend = function (a, b, c) {
      if (c.length && b && (b instanceof _t || b.__dt_wrapper)) {
        ...
        for (d = c.length; e < d; e++) {
          f = c[e], b[f.name] = "function" === typeof f.val ? g(a, f.val, f) : h.isPlainObject(f.val) ? {} : f.val, b[f.name].__dt_wrapper = !0, _t.extend(a, b[f.name], f.propExt);
        }
      }
    };

    _t.register = r = function r(a, b) {
      if (h.isArray(a)) for (var c = 0, e = a.length; c < e; c++) {
        _t.register(a[c], b);
    ...
    _t.registerPlural = v = function v(a, b, c) {
      _t.register(a, c);
      ...
      if (c.length && a.length) {
        ...
        if (e._details) {
          ...
          0 < D(g, "_details").length && (f.on("draw.dt.DT_details", function (a, b) {
            ...
            if (d === b) for (var c, e = aa(b), f = 0, h = g.length; f < h; f++) {
              c = g[f], c._details && c._details.children("td[colspan]").attr("colspan", e);
            }
          }), f.on("destroy.dt.DT_details", function (a, b) {
            if (d === b) for (var c = 0, e = g.length; c < e; c++) {
              g[c]._details && cb(f, c);
            }
          }));
        }
    ...
    _m.versionCheck = _m.fnVersionCheck = function (a) {
      for (var b = _m.version.split("."), a = a.split("."), c, e, d = 0, f = a.length; d < f; d++) {
    ...
    _m.isDataTable = _m.fnIsDataTable = function (a) {
      var b = h(a).get(0),
          c = !1;
      h.each(_m.settings, function (a, d) {
    ...
    _m.tables = _m.fnTables = function (a) {
      return h.map(_m.settings, function (b) {
    ...
    r("destroy()", function (a) {
      ...
      return this.iterator("table", function (b) {
        ...
        c = h.inArray(b, _m.settings);
        -1 !== c && _m.settings.splice(c, 1);
      });
    });
    h.each(["column", "row", "cell"], function (a, b) {
      r(b + "s().every()", function (a) {
        return this.iterator(b, function (e, d, f) {
          a.call(new _t(e)[b](d, f));
        });
      });
    });
    ...
    _m.defaults = {
      ...
      oSearch: h.extend({}, _m.models.oSearch),
      sAjaxDataProp: "data",
      sAjaxSource: null,
      sDom: "lfrtip",
      searchDelay: null,
    ...
    _m.ext = u = {
      ...
      _unique: 0,
      fnVersionCheck: _m.fnVersionCheck,
      iApiIndex: 0,
      oJUIClasses: {},
      sVersion: _m.version
    };
    ...
    h.extend(_m.ext.oJUIClasses, _m.ext.classes, {
    ...
    h.fn.dataTable = _m;
    h.fn.dataTableSettings = _m.settings;
    h.fn.dataTableExt = _m.ext;
  ...
  "function" === typeof define && define.amd ? define("datatables", ["jquery"], P) : "object" === (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = P(require("jquery")) : jQuery && !jQuery.fn.dataTable && P(jQuery);
})(window, document);