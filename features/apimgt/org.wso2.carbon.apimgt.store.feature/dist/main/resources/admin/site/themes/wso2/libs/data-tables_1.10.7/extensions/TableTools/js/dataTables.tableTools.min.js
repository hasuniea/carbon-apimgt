...
(function (n, k, q) {
  var p = function p(m, _p) {
    ...
    g.Client.prototype = {
      ...
      receiveEvent: function receiveEvent(a, b) {
        ...
        if (this.handlers[a]) for (var d = 0, f = this.handlers[a].length; d < f; d++) {
          ...
          if ("function" == typeof e) e(this, b);else if ("object" == _typeof(e) && 2 == e.length) e[0][e[1]](this, b);else if ("string" == typeof e) n[e](this, b);
        }
      }
    };
    ...
    _TableTools = function TableTools(a, b) {
      !this instanceof _TableTools && alert("Warning: TableTools must be initialised with the keyword 'new'");
      this.s = {
        that: this,
      ...
      this.classes = e.extend(!0, {}, _TableTools.classes);
      this.s.dt.bJUI && e.extend(!0, this.classes, _TableTools.classes_themeroller);
    ...
    _TableTools.prototype = {
      fnGetSelected: function fnGetSelected(a) {
        var b = [],
            c = this.s.dt.aoData,
      ...
      fnGetSelectedIndexes: function fnGetSelectedIndexes(a) {
        var b = [],
            c = this.s.dt.aoData,
            d = this.s.dt.aiDisplay,
            f;
      ...
      _fnConstruct: function _fnConstruct(a) {
        ...
        this.s.dt.aoDestroyCallback.push({
          ...
          fn: function fn() {
            ...
            var a = e.inArray(b, _TableTools._aInstances);
            -1 !== a && _TableTools._aInstances.splice(a, 1);
          }
        });
      },
      _fnCustomiseSettings: function _fnCustomiseSettings(a) {
        ...
        this.s.custom = e.extend({}, _TableTools.DEFAULTS, a);
      ...
      _fnButtonDefinations: function _fnButtonDefinations(a, b) {
        for (var c, d = 0, f = a.length; d < f; d++) {
          if ("string" == typeof a[d]) {
            if ("undefined" == typeof _TableTools.BUTTONS[a[d]]) {
              alert("TableTools: Warning - unknown button type: " + a[d]);
              continue;
            }

            c = e.extend({}, _TableTools.BUTTONS[a[d]], !0);
          } else {
            if ("undefined" == typeof _TableTools.BUTTONS[a[d].sExtends]) {
              alert("TableTools: Warning - unknown button type: " + a[d].sExtends);
              continue;
            }

            c = e.extend({}, _TableTools.BUTTONS[a[d].sExtends], !0);
            c = e.extend(c, a[d], !0);
          }
      ...
      _fnGetMasterSettings: function _fnGetMasterSettings() {
        ...
        for (var a = _TableTools._aInstances, b = 0, c = a.length; b < c; b++) {
        ...
        if (this.s.master) {
          ...
          e(b.nTBody).on("click.DTTT_Select", this.s.custom.sRowSelector, function (c) {
            ...
            if (d.parentNode == b.nTBody && b.oInstance.fnGetData(d) !== null) {
              if (f.type == "os") {
                if (c.ctrlKey || c.metaKey) a.fnIsSelected(d) ? a._fnRowDeselect(d, c) : a._fnRowSelect(d, c);else if (c.shiftKey) {
      ...
      _fnRowSelect: function _fnRowSelect(a, b) {
        ...
        if (null === this.s.select.preRowSelect || this.s.select.preRowSelect.call(this, b, d, !0)) {
          ...
          _TableTools._fnEventDispatch(this, "select", d, !0);
        }
      },
      _fnRowDeselect: function _fnRowDeselect(a, b) {
        ...
        if (null === this.s.select.preRowSelect || this.s.select.preRowSelect.call(this, b, d, !1)) {
          ...
          _TableTools._fnEventDispatch(this, "select", d, !1);
        }
      },
      ...
      _fnTextConfig: function _fnTextConfig(a, b) {
        ...
        null !== b.fnSelect && _TableTools._fnEventListen(this, "select", function (d) {
      ...
      _fnColumnTargets: function _fnColumnTargets(a) {
        ...
        } else if ("visible" == a) for (c = 0; c < d; c++) {
          b.push(f[c].bVisible ? !0 : !1);
        } else if ("hidden" == a) for (c = 0; c < d; c++) {
          b.push(f[c].bVisible ? !1 : !0);
        } else if ("sortable" == a) for (c = 0; c < d; c++) {
      ...
      _fnGetDataTablesData: function _fnGetDataTablesData(a) {
        ...
        m = (d = "none" !== this.s.select.type && d && 0 !== f.length) ? f : _p.Api ? new _p.Api(g).rows(a.oSelectorOpts).indexes().flatten().toArray() : g.oInstance.$("tr", a.oSelectorOpts).map(function (a, b) {
      ...
      _fnPrintStart: function _fnPrintStart(a) {
        ...
        for (f in d) {
          if ("i" != f && "t" != f && 1 == f.length) for (var g = 0, i = d[f].length; g < i; g++) {
    ...
    _TableTools.fnGetMasters = function () {
      for (var a = [], b = 0, c = _TableTools._aInstances.length; b < c; b++) {
        _TableTools._aInstances[b].s.master && a.push(_TableTools._aInstances[b]);
      }

      return a;
    };

    _TableTools.fnGetInstance = function (a) {
      "object" != _typeof(a) && (a = k.getElementById(a));

      for (var b = 0, c = _TableTools._aInstances.length; b < c; b++) {
        if (_TableTools._aInstances[b].s.master && _TableTools._aInstances[b].dom.table == a) return _TableTools._aInstances[b];
      }

      return null;
    };

    _TableTools._fnEventListen = function (a, b, c) {
    ...
    _TableTools._fnEventDispatch = function (a, b, c, d) {
      for (var f = _TableTools._aListeners, e = 0, g = f.length; e < g; e++) {
    ...
    _TableTools.BUTTONS = {
      csv: e.extend({}, _TableTools.buttonBase, {
        sAction: "flash_save",
        sButtonClass: "DTTT_button_csv",
        sButtonText: "CSV",
        sFieldBoundary: '"',
        sFieldSeperator: ",",
        fnClick: function fnClick(a, b, c) {
          this.fnSetText(c, this.fnGetTableData(b));
        }
      }),
      xls: e.extend({}, _TableTools.buttonBase, {
        sAction: "flash_save",
        sCharSet: "utf16le",
        bBomInc: !0,
      ...
      copy: e.extend({}, _TableTools.buttonBase, {
        sAction: "flash_copy",
      ...
      pdf: e.extend({}, _TableTools.buttonBase, {
        sAction: "flash_pdf",
        sNewLine: "\n",
        sFileName: "*.pdf",
      ...
      print: e.extend({}, _TableTools.buttonBase, {
        ...
        sButtonText: "Print",
        fnClick: function fnClick(a, b) {
          this.fnPrint(!0, b);
        }
      }),
      text: e.extend({}, _TableTools.buttonBase),
      select: e.extend({}, _TableTools.buttonBase, {
      ...
      select_single: e.extend({}, _TableTools.buttonBase, {
        sButtonText: "Select button",
        fnSelect: function fnSelect(a) {
      ...
      select_all: e.extend({}, _TableTools.buttonBase, {
      ...
      select_none: e.extend({}, _TableTools.buttonBase, {
      ...
      ajax: e.extend({}, _TableTools.buttonBase, {
        sAjaxUrl: "/xhr.php",
      ...
      div: e.extend({}, _TableTools.buttonBase, {
        sAction: "div",
        sTag: "div",
        sButtonClass: "DTTT_nonbutton",
        sButtonText: "Text button"
      }),
      collection: e.extend({}, _TableTools.buttonBase, {
        sAction: "collection",
    ...
    _TableTools.version = "2.2.4";
    e.fn.dataTable.Api && e.fn.dataTable.Api.register("tabletools()", function () {
      var a = null;
      0 < this.context.length && (a = _TableTools.fnGetInstance(this.context[0].nTable));
      return a;
    });
    "function" == typeof e.fn.dataTable && "function" == typeof e.fn.dataTableExt.fnVersionCheck && e.fn.dataTableExt.fnVersionCheck("1.9.0") ? e.fn.dataTableExt.aoFeatures.push({
      fnInit: function fnInit(a) {
        var b = a.oInit;
        return new _TableTools(a.oInstance, b ? b.tableTools || b.oTableTools || {} : {}).dom.container;
      },
      cFeature: "T",
      sFeature: "TableTools"
    }) : alert("Warning: TableTools requires DataTables 1.9.0 or newer - www.datatables.net/download");
    e.fn.DataTable.TableTools = _TableTools;
    "function" == typeof m.fn.dataTable && "function" == typeof m.fn.dataTableExt.fnVersionCheck && m.fn.dataTableExt.fnVersionCheck("1.9.0") ? m.fn.dataTableExt.aoFeatures.push({
      fnInit: function fnInit(a) {
        a = new _TableTools(a.oInstance, "undefined" != typeof a.oInit.oTableTools ? a.oInit.oTableTools : {});

        _TableTools._aInstances.push(a);
    ...
    m.fn.dataTable.TableTools = _TableTools;
    return m.fn.DataTable.TableTools = _TableTools;
  };

  "function" === typeof define && define.amd ? define(["jquery", "datatables"], p) : "object" === (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? p(require("jquery"), require("datatables")) : jQuery && !jQuery.fn.dataTable.TableTools && p(jQuery, jQuery.fn.dataTable);
})(window, document);