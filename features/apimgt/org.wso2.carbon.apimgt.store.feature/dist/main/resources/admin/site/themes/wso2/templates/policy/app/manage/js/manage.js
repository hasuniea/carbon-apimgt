...
var deleteAppPolicy = function deleteAppPolicy(policyObject) {
...
$(function () {
  ...
  $('#app-policy').datatables_extended({
    "fnDrawCallback": function fnDrawCallback() {
      if (this.fnSettings().fnRecordsDisplay() <= $("#app-policy_length option:selected").val() || $("#app-policy_length option:selected").val() == -1) $('#app-policy_paginate').hide();else $('#app-policy_paginate').show();
    },
