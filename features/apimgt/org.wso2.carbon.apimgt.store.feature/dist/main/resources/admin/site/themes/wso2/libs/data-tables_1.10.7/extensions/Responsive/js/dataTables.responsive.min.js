...
*/
(function (n, p) {
  var o = function o(e, k) {
    var h = function h(d, a) {
    ...
    h.prototype = {
      _constructor: function _constructor() {
        ...
        e(n).on("resize.dtr orientationchange.dtr", a.settings()[0].oApi._fnThrottle(function () {
          d._resize();
        }));
      ...
      _columnsVisiblity: function _columnsVisiblity(d) {
        var a = this.s.dt,
            c = this.s.columns,
            b,
            g,
      ...
      _classLogic: function _classLogic() {
        var d = this,
          ...
          return {
            ...
            b = function b(a, _b) {
          var d = c[a].includeIn;
          -1 === e.inArray(_b, d) && d.push(_b);
        },
            g = function g(f, _g, e, j) {
          if (e) {
            if ("max-" === e) {
              j = d._find(_g).width;
              _g = 0;

              for (e = a.length; _g < e; _g++) {
                a[_g].width <= j && b(f, a[_g].name);
              }
            } else if ("min-" === e) {
              j = d._find(_g).width;
              _g = 0;
              ...
              if ("not-" === e) {
                ...
                for (e = a.length; _g < e; _g++) {
                  -1 === a[_g].name.indexOf(j) && b(f, a[_g].name);
                }
              }
            }
          } else c[f].includeIn.push(_g);
        };
    ...
    h.defaults = {
      ...
      auto: !0,
      details: {
        renderer: function renderer(d, a) {
  ...
  "function" === typeof define && define.amd ? define(["jquery", "datatables"], o) : "object" === (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? o(require("jquery"), require("datatables")) : jQuery && !jQuery.fn.dataTable.Responsive && o(jQuery, jQuery.fn.dataTable);
})(window, document);