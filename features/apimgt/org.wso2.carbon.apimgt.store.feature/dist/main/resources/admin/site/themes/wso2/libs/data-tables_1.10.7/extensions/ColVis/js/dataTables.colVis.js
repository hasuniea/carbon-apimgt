...
(function (window, document, undefined) {
  var factory = function factory($, DataTable) {
    ...
    var ColVis = function ColVis(oDTSettings, oInit) {
    ...
    ColVis.prototype = {
       ...
       *  @private
       */
      "_fnConstruct": function _fnConstruct(init) {
       ...
       *  @private
       */
      "_fnApplyCustomisation": function _fnApplyCustomisation(init) {
        $.extend(true, this.s, ColVis.defaults, init); // Slightly messy overlap for the camelCase notation
      ...
      "_fnDrawCallback": function _fnDrawCallback() {
        ...
        var allVisible = function allVisible(columnIndeces) {
        ...
        var allHidden = function allHidden(columnIndeces) {
       ...
       *  @private
       */
      "_fnAddGroups": function _fnAddGroups() {
        var nButton;
       ...
       *  @private
       */
      "_fnAddButtons": function _fnAddButtons() {
        var nButton,
       ...
       *  @private
       */
      "_fnDomRestoreButton": function _fnDomRestoreButton() {
        var that = this,
            dt = this.s.dt;
       ...
       *  @private
       */
      "_fnDomShowXButton": function _fnDomShowXButton(str, action) {
        var that = this,
            dt = this.s.dt;
       ...
       *  @private
       */
      "_fnDomGroupButton": function _fnDomGroupButton(i) {
        var that = this,
            dt = this.s.dt,
       ...
       *  @private
       */
      "_fnDomColumnButton": function _fnDomColumnButton(i) {
        var that = this,
        ...
        return $('<li ' + (dt.bJUI ? 'class="ui-button ui-state-default"' : '') + '>' + '<label>' + '<input type="checkbox" />' + '<span>' + title + '</span>' + '</label>' + '</li>').click(function (e) {
          ...
          $.fn.dataTableExt.iApiIndex = that._fnDataTablesApiIndex.call(that); // Optimisation for server-side processing when scrolling - don't do a full redraw
       ...
       *  @private
       */
      "_fnDataTablesApiIndex": function _fnDataTablesApiIndex() {
       ...
       *  @private
       */
      "_fnDomCollection": function _fnDomCollection() {
        return $('<ul />', {
       ...
       *  @private
       */
      "_fnDomCatcher": function _fnDomCatcher() {
        var that = this,
       ...
       *  @private
       */
      "_fnDomBackground": function _fnDomBackground() {
        var that = this;
       ...
       *  @private
       */
      "_fnCollectionShow": function _fnCollectionShow() {
        var that = this,
            i,
            iLen,
            iLeft;
       ...
       *  @private
       */
      "_fnCollectionHide": function _fnCollectionHide() {
        var that = this;
       ...
       */
      "_fnAdjustOpenRows": function _fnAdjustOpenRows() {
