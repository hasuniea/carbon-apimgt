...
(function (r, s, t) {
  var p = function p(d) {
    var j = function j(a, b) {
      ...
      if (this instanceof j) {
        ...
        this.s = {
          dt: g,
          iTableColumns: g.aoColumns.length,
          aiOuterWidths: [],
          aiInnerWidths: []
        };
        this.dom = {
    ...
    j.prototype = {
      ...
      fnRecalculateHeight: function fnRecalculateHeight(a) {
        delete a._DTTC_iHeight;
        a.style.height = "auto";
      },
      fnSetRowHeight: function fnSetRowHeight(a, b) {
        a.style.height = b + "px";
      },
      fnGetPosition: function fnGetPosition(a) {
      ...
      _fnConstruct: function _fnConstruct(a) {
        var b = this;
        if ("function" != typeof this.s.dt.oInstance.fnVersionCheck || !0 !== this.s.dt.oInstance.fnVersionCheck("1.8.0")) alert("FixedColumns " + j.VERSION + " required DataTables 1.8.0 or later. Please upgrade your DataTables installation");else if ("" === this.s.dt.oScroll.sX) this.s.dt.oInstance.oApi._fnLog(this.s.dt, 1, "FixedColumns is not needed (no x-scrolling in DataTables enabled), so no action will be taken. Use 'FixedHeader' for column fixing when scrolling is not enabled");else {
      ...
      _fnGridSetup: function _fnGridSetup() {
        ...
        0 < this.s.iRightColumns && (this.dom.grid.right.wrapper = f, this.dom.grid.right.head = f.childNodes[0], this.dom.grid.right.body = f.childNodes[1], this.dom.grid.right.liner = d("div.DTFC_RightBodyLiner", c)[0], b = d("div.DTFC_RightHeadBlocker", c)[0], b.style.width = a.bar + "px", b.style.right = -a.bar + "px", this.dom.grid.right.headBlock = b, b = d("div.DTFC_RightFootBlocker", c)[0], b.style.width = a.bar + "px", b.style.right = -a.bar + "px", this.dom.grid.right.footBlock = b, c.appendChild(f));
      ...
      _fnGridLayout: function _fnGridLayout() {
        var a = this.dom.grid,
            b = d(a.wrapper).width(),
            c = d(this.s.dt.nTable.parentNode).outerHeight(),
            g = d(this.s.dt.nTable.parentNode.parentNode).outerHeight(),
        ...
        0 < this.s.iLeftColumns && (a.left.wrapper.style.width = e + "px", a.left.wrapper.style.height = "1px", a.left.body.style.height = c + "px", a.left.foot && (a.left.foot.style.top = (f.x ? f.bar : 0) + "px"), i(a.left.liner, e), a.left.liner.style.height = c + "px");
        0 < this.s.iRightColumns && (b -= h, f.y && (b -= f.bar), a.right.wrapper.style.width = h + "px", a.right.wrapper.style.left = b + "px", a.right.wrapper.style.height = "1px", a.right.body.style.height = c + "px", a.right.foot && (a.right.foot.style.top = (f.x ? f.bar : 0) + "px"), i(a.right.liner, h), a.right.liner.style.height = c + "px", a.right.headBlock.style.display = f.y ? "block" : "none", a.right.footBlock.style.display = f.y ? "block" : "none");
      },
      ...
      _fnCloneRight: function _fnCloneRight(a) {
      ...
      _fnCloneLeft: function _fnCloneLeft(a) {
      ...
      _fnCopyLayout: function _fnCopyLayout(a, b) {
        for (var c = [], g = [], f = [], e = 0, h = a.length; e < h; e++) {
          ...
          for (var k = 0, j = this.s.iTableColumns; k < j; k++) {
            if (-1 !== d.inArray(k, b)) {
              ...
              -1 === m ? (m = d(a[e][k].cell).clone(!0, !0)[0], g.push(m), f.push(a[e][k].cell), i.push({
                cell: m,
                unique: a[e][k].unique
              })) : i.push({
                cell: g[m],
      ...
      _fnClone: function _fnClone(a, b, c, g) {
        var f = this,
            e,
            h,
            i,
          ...
          for (h = n.length; e < h; e++) {
            ...
            for (k = n[e].length; i < k; i++) {
              q[e][i].cell.className = n[e][i].cell.className, d("span.DataTables_sort_icon", q[e][i].cell).each(function () {
                this.className = d("span.DataTables_sort_icon", n[e][i].cell)[0].className;
              });
            }
          }
        }
        ...
        if (null !== l.nTFoot) {
          if (g) {
            ...
            l.oApi._fnDetectHeader(b, d(">tfoot", a.footer)[0]);
      ...
      _fnGetTrNodes: function _fnGetTrNodes(a) {
      ...
      _fnEqualiseHeights: function _fnEqualiseHeights(a, b, c) {
        if (!("none" == this.s.sHeightMatch && "thead" !== a && "tfoot" !== a)) {
          ...
          for (var e = this._fnGetTrNodes(e), b = this._fnGetTrNodes(c), h = [], c = 0, a = b.length; c < a; c++) {
            g = e[c].offsetHeight, f = b[c].offsetHeight, g = f > g ? f : g, "semiauto" == this.s.sHeightMatch && (e[c]._DTTC_iHeight = g), h.push(g);
          }
  ...
  "function" === typeof define && define.amd ? define(["jquery", "datatables"], p) : "object" === (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? p(require("jquery"), require("datatables")) : jQuery && !jQuery.fn.dataTable.FixedColumns && p(jQuery, jQuery.fn.dataTable);
})(window, document);