...
(function (F, n, K) {
  var A = function A(d) {
    KeyTable = function KeyTable(j) {
      function A(a) {
        return function (e, c, p) {
          (null === e || "number" == typeof e) && (null === c || "number" == typeof c) && "function" == typeof p ? k[a].push({
            ...
            y: c,
            fn: p
          }) : "object" == _typeof(e) && "function" == typeof c ? (e = E(e), k[a].push({
            x: e[0],
            y: e[1],
            fn: c
      ...
      function L(a) {
        return function (e, c, p) {
          (null === e || "number" == typeof e) && (null === c || "number" == typeof c) ? "function" == typeof p ? B(a, e, c, p) : B(a, e, c) : "object" == _typeof(e) ? (e = E(e), "function" == typeof c ? B(a, e[0], e[1], c) : B(a, e[0], e[1])) : alert("Unhandable event type was removed: x" + e + "  y:" + c + "  z:" + p);
        };
      }

      function B(a, e, c, p) {
        for (var h = 0, b = 0, d = k[a].length; b < d - h; b++) {
          if ("undefined" != typeof p) k[a][b - h].x == e && k[a][b - h].y == c && k[a][b - h].fn == p && (k[a].splice(b - h, 1), h++);else if (k[a][b - h].x == e && k[a][b - h].y == c) return k[a].splice(b, 1), 1;
        }
      ...
      function C(a, e, c) {
        for (var p = 0, a = k[a], b = 0; b < a.length; b++) {
          if (a[b].x == e && a[b].y == c || null === a[b].x && a[b].y == c || a[b].x == e && null === a[b].y || null === a[b].x && null === a[b].y) a[b].fn(w(e, c), e, c), p++;
        }
      ...
      function q(a, e) {
        if (t != a) {
          ...
          if (e) {
            ...
            f = [q, s];
            if (i && "undefined" != typeof c.oScroll && ("" !== c.oScroll.sX || "" !== c.oScroll.sY)) f[1] -= d(c.nTable.parentNode).scrollTop(), f[0] -= d(c.nTable.parentNode).scrollLeft();
          ...
          if (i && "undefined" != typeof c.oScroll && ("" !== c.oScroll.sX || "" !== c.oScroll.sY)) (c = c.nTable.parentNode, r = c.clientHeight, b = c.clientWidth, j = c.scrollTop, h = c.scrollLeft, k = a.offsetHeight, m = a.offsetWidth, a.offsetTop + k > r + j ? c.scrollTop = a.offsetTop + k - r : a.offsetTop < j && (c.scrollTop = a.offsetTop), a.offsetLeft + m > b + h) ? c.scrollLeft = a.offsetLeft + m - b : a.offsetLeft < h && (c.scrollLeft = a.offsetLeft);
          o || (o = !0);
          C("focus", l, g);
        }
      }
      ...
      this.fnSetPosition = function (a, b) {
        "object" == _typeof(a) && a.nodeName ? q(a) : q(w(a, b));
      };
      ...
      d(n).bind("keydown", function (a) {
        if (J.block || !o || a.metaKey || a.altKey || a.ctrlKey) return true;
        var b;
        ...
        if (i) {
          ...
          l = d[0];
          g = d[1];
        } else c = z.getElementsByTagName("tr").length;
      ...
      if (i) d(i.nTable).on("click", "td", I);else d(z).on("click", "td", I);
  ...
  "function" === typeof define && define.amd ? define(["jquery", "datatables"], A) : "object" === (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? A(require("jquery"), require("datatables")) : jQuery && !jQuery.fn.dataTable.KeyTable && A(jQuery, jQuery.fn.dataTable);
})(window, document);