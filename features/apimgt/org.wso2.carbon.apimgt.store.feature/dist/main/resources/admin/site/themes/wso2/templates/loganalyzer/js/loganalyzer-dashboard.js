      ...
      "default": {
        ...
        "application-errors-log-error-bar-chart": [{
          ...
          "content": {
            ...
            "data": {
              "url": "store://gadget/LogErrorBarChart/index.xml"
            },
            "notify": {
              "publisher": {
                "type": "filter",
      ...
      "default": {
        ...
        "artifact-deployment-stats-artifact-deployment": [{
          ...
          "content": {
            ...
            "data": {
              "url": "store://gadget/LogArtifactDeployed/index.xml"
            },
            "listen": {
              "subscriber": {
                "type": "date-range",
        ...
        "artifact-deployment-stats-artifact-deleted": [{
          ...
          "content": {
            ...
            "data": {
              "url": "store://gadget/LogArtifactDeleted/index.xml"
            },
            "listen": {
              "subscriber": {
                "type": "date-range",
      ...
      "default": {
        "7d8074704d9a3c81174d577910e23333": [{
          ...
          "content": {
            ...
            "data": {
              "url": "store://gadget/LiveLogViewer/index.xml"
            },
            "listen": {
              "subscriber": {
                "type": "date-range",
