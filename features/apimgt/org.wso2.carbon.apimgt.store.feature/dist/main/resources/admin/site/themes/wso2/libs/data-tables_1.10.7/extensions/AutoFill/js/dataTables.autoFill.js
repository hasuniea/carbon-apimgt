...
(function (window, document, undefined) {
  var factory = function factory($, DataTable) {
    ...
    var AutoFill = function AutoFill(oDT, oConfig) {
    ...
    AutoFill.prototype = {
       ...
       *  @returns void
       */
      "_fnInit": function _fnInit(dt, config) {
        var that = this,
            i,
            iLen; // Use DataTables API to get the settings allowing selectors, instances
        // etc to be used, or for backwards compatibility get from the old
        // fnSettings method

        this.s.dt = DataTable.Api ? new DataTable.Api(dt).settings()[0] : dt.fnSettings();
        this.s.init = config || {};
        ...
        this.dom.filler = filler[0]; // Get the height / width of the click element
        ...
        $('tbody', this.dom.table).on('mouseover.DTAF mouseout.DTAF', '>tr>td, >tr>th', function (e) {
      ...
      _initColumns: function _initColumns() {
        ...
        dt.oApi._fnApplyColumnDefs(dt, config.aoColumnDefs || config.columnDefs, config.aoColumns || config.columns, function (colIdx, def) {
      ...
      "_fnColumnOptions": function _fnColumnOptions(i, opts) {
        var column = this.s.columns[i];

        var set = function set(outProp, inProp) {
       ...
       */
      "_fnTargetCoords": function _fnTargetCoords(nTd) {
       ...
       *  @returns void
       */
      "_fnUpdateBorder": function _fnUpdateBorder(nStart, nEnd) {
        var border = this.s.border.width,
            ...
            oStyle; // Recalculate start and end (when dragging "backwards")  
       ...
       *  @returns void
       */
      "_fnFillerDragStart": function _fnFillerDragStart(e) {
        var that = this;
       ...
       *  @returns void
       */
      "_fnFillerDragMove": function _fnFillerDragMove(e) {
        if (e.target && e.target.nodeName.toUpperCase() == "TD" && e.target != this.s.drag.endTd) {
       ...
       *  @returns void
       */
      "_fnFillerFinish": function _fnFillerFinish(e) {
        var that = this,
            i,
            iLen,
            j;
        ...
        var columnIndex = function columnIndex(visIdx) {
       ...
       *  @returns void
       */
      "_fnFillerDisplay": function _fnFillerDisplay(e) {
       ...
       *  @returns void
       */
      "_fnFillerPosition": function _fnFillerPosition(nTd) {
    ...
    AutoFill.defaults = {
      ...
      column: {
         ...
         */
        step: function step(cell, read, last, i, x, y) {
