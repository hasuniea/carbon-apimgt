...
(function (j, i, k) {
  j = function j(d) {
    var e = function e(a, b) {
      ...
      this.s.dt = d.fn.dataTable.Api ? new d.fn.dataTable.Api(a).settings()[0] : a;
    ...
    e.prototype = {
      ...
      _fnApplyCustomisation: function _fnApplyCustomisation(a) {
      ...
      _fnAddGroups: function _fnAddGroups() {
        var a;
        if ("undefined" != typeof this.s.aoGroups) for (var b = 0, c = this.s.aoGroups.length; b < c; b++) {
      ...
      _fnAddButtons: function _fnAddButtons() {
        var a,
            b = this.s.dt.aoColumns;
        if (-1 === d.inArray("all", this.s.aiExclude)) for (var c = 0, f = b.length; c < f; c++) {
      ...
      _fnDomShowXButton: function _fnDomShowXButton(a, b) {
        var c = this;
      ...
      _fnDomGroupButton: function _fnDomGroupButton(a) {
        var b = this,
            c = this.s.aoGroups[a];
      ...
      _fnDomColumnButton: function _fnDomColumnButton(a) {
        var b = this,
  ...
  "function" === typeof define && define.amd ? define(["jquery", "datatables"], j) : "object" === (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? j(require("jquery"), require("datatables")) : jQuery && !jQuery.fn.dataTable.ColVis && j(jQuery, jQuery.fn.dataTable);
})(window, document);