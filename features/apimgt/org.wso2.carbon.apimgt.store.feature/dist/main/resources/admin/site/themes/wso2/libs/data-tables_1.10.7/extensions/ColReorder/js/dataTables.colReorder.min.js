...
(function (o, r, s) {
  ...
  o = function o(d) {
    d.fn.dataTableExt.oApi.fnColReorder = function (a, b, e) {
      ...
      if (b != e) if (0 > b || b >= n) this.oApi._fnLog(a, 1, "ColReorder 'from' index is out of bounds: " + b);else if (0 > e || e >= n) this.oApi._fnLog(a, 1, "ColReorder 'to' index is out of bounds: " + e);else {
        ...
        d(a.oInstance).trigger("column-reorder", [a, {
          iFrom: b,
          iTo: e,
          aiInvertMapping: k
        }]);
    ...
    f.prototype = {
      ...
      _fnConstruct: function _fnConstruct() {
        ...
        if (d) {
          if (a.s.dt._bInitComplete) b = p(d), a._fnOrderColumns.call(a, b);else {
            var c = !1;
      ...
      _fnMouseDown: function _fnMouseDown(a, b) {
        var e = this,
            f = d(a.target).closest("th, td").offset(),
            c = parseInt(d(b).attr("data-column-index"), 10);
  ...
  "function" === typeof define && define.amd ? define(["jquery", "datatables"], o) : "object" === (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? o(require("jquery"), require("datatables")) : jQuery && !jQuery.fn.dataTable.ColReorder && o(jQuery, jQuery.fn.dataTable);
})(window, document);