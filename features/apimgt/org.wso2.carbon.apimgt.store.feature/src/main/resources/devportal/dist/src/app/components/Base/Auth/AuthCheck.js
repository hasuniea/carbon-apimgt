...
var _ResourceNotFound = _interopRequireDefault(require("../Errors/ResourceNotFound"));
...
var AuthCheck = /*#__PURE__*/function (_Component) {
  ...
  function AuthCheck(props) {
    ...
    _this.state = {
      isLogged: _AuthManager["default"].getUser()
    };

    if (props.response) {
      var status = props.response.status;
      _this.state.isAuthorize = status !== 401;
      _this.state.resourceNotFound = status == 404;
    }
  ...
  _createClass(AuthCheck, [{
    ...
    value: function render() {
      if (!this.state.isLogged || this.state.isAuthorize === false) {
        ...
        return /*#__PURE__*/_react["default"].createElement(_ResourceNotFound["default"], this.props);
      } else {
