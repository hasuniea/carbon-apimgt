...
module.exports = {
  ...
  moduleNameMapper: {
    ...
    '\\.(jpg|jpeg|png|gif|eot|otf|webp|svg|ttf|woff|woff2|mp4|webm|wav|mp3|m4a|aac|oga)$': '<rootDir>/source/Tests/Unit/__mocks__/fileMock.js',
  ...
  coverageReporters: ['json', 'text', 'lcov', 'clover', 'html'] // The test environment that will be used for testing,
