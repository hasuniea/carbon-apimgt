...
(function (window, document, undefined) {
  var factory = function factory($, DataTable) {
    ...
    _FixedHeader = function FixedHeader(mTable, oInit) {
      ...
      var oSettings = {
        ...
        "oMes": {
          ...
          /* note this is left+width, not actually "right" */
          "iTableTop": 0,
          "iTableBottom": 0
    ...
    _FixedHeader.prototype = {
       ...
       */
      fnInit: function fnInit(oDtSettings, oInit) {
        ...
        _FixedHeader.afnScroll.push(function () {
          that._fnUpdatePositions.call(that);
        });
       ...
       */
      fnInitSettings: function fnInitSettings(s, oInit) {
        if (oInit !== undefined) {
       ...
       * Inputs:   -
       */
      _fnCloneTable: function _fnCloneTable(sType, sClass, fnClone, iCells) {
        var s = this.fnGetSettings();
        var nCTable;
      ...
      _fnMeasure: function _fnMeasure() {
        ...
        m.iTableRight = _FixedHeader.oDoc.iWidth - m.iTableLeft - m.iTableWidth;
        m.iTableBottom = _FixedHeader.oDoc.iHeight - m.iTableTop - m.iTableHeight;
      },
       ...
       */
      _fnSumScroll: function _fnSumScroll(n, side) {
        var i = n[side];
       ...
       * Inputs:   -
       */
      _fnUpdateClones: function _fnUpdateClones(full) {
        var s = this.fnGetSettings();
       ...
       */
      _fnScrollHorizontalRight: function _fnScrollHorizontalRight(oCache) {
        var s = this.fnGetSettings(),
            oMes = s.oMes,
            oWin = _FixedHeader.oWin,
            oDoc = _FixedHeader.oDoc,
       ...
       * Inputs:   object:oCache - the cached values for this fixed element
       */
      _fnScrollHorizontalLeft: function _fnScrollHorizontalLeft(oCache) {
        var s = this.fnGetSettings(),
            oMes = s.oMes,
            oWin = _FixedHeader.oWin,
            oDoc = _FixedHeader.oDoc,
       ...
       * Inputs:   object:oCache - the cached values for this fixed element
       */
      _fnScrollFixedFooter: function _fnScrollFixedFooter(oCache) {
        var s = this.fnGetSettings(),
            oMes = s.oMes,
            oWin = _FixedHeader.oWin,
            oDoc = _FixedHeader.oDoc,
       ...
       * Inputs:   object:oCache - the cached values for this fixed element
       */
      _fnScrollFixedHeader: function _fnScrollFixedHeader(oCache) {
        var s = this.fnGetSettings(),
            oMes = s.oMes,
            oWin = _FixedHeader.oWin,
            oDoc = _FixedHeader.oDoc,
       ...
       */
      _fnUpdateCache: function _fnUpdateCache(oCache, sCache, sSet, sProperty, oObj) {
       ...
       */
      _fnClassUpdate: function _fnClassUpdate(source, dest) {
        var that = this;
       ...
       * Inputs:   object:oCache - the cached values for this fixed element
       */
      _fnCloneThead: function _fnCloneThead(oCache) {
        var s = this.fnGetSettings();
       ...
       * Inputs:   object:oCache - the cached values for this fixed element
       */
      _fnCloneTfoot: function _fnCloneTfoot(oCache) {
        var s = this.fnGetSettings();
        var nTable = oCache.nNode;
        /* Set the wrapper width to match that of the cloned table */
       ...
       * Inputs:   object:oCache - the cached values for this fixed element
       */
      _fnCloneTLeft: function _fnCloneTLeft(oCache) {
        var s = this.fnGetSettings();
        var nTable = oCache.nNode;
       ...
       * Inputs:   object:oCache - the cached values for this fixed element
       */
      _fnCloneTRight: function _fnCloneTRight(oCache) {
        var s = this.fnGetSettings();
        var nBody = $('tbody', s.nTable)[0];
        var nTable = oCache.nNode;
       ...
       *  @private
       */
      "fnEqualiseHeights": function fnEqualiseHeights(parent, original, clone) {
        var that = this;
        var originals = $(parent + ' tr', original);
        var height;
        $(parent + ' tr', clone).each(function (k) {
          height = originals.eq(k).css('height'); // This is nasty :-(. IE has a sub-pixel error even when setting
          ...
          $(this).css('height', height); // For Firefox to work, we need to also set the height of the
    ...
    $(window).scroll(function () {
      ...
      for (var i = 0, iLen = _FixedHeader.afnScroll.length; i < iLen; i++) {
        _FixedHeader.afnScroll[i]();
      }
    });
