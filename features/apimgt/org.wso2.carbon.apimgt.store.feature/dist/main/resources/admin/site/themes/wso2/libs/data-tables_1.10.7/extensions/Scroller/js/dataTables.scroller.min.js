...
(function (m, n, k) {
  var l = function l(e) {
    ...
    g.prototype = {
      ...
      _fnCalcRowHeight: function _fnCalcRowHeight() {
        ...
        a._bInitComplete ? a = b.parentNode : (this.s.dt.nHolding || (this.s.dt.nHolding = e("<div></div>").insertBefore(this.s.dt.nTable)), a = this.s.dt.nHolding);
        f.appendTo(a);
  ...
  "function" === typeof define && define.amd ? define(["jquery", "datatables"], l) : "object" === (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? l(require("jquery"), require("datatables")) : jQuery && !jQuery.fn.dataTable.Scroller && l(jQuery, jQuery.fn.dataTable);
})(window, document);