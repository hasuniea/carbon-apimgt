...
var styles = function styles(theme) {
  ...
  return {
    ...
    }, _defineProperty(_apiDetails, "padding", theme.spacing.unit), _defineProperty(_apiDetails, "color", theme.palette.getContrastText(theme.custom.thumbnail.contentBackgroundColor)), _defineProperty(_apiDetails, '& a', {
...
var RecommendedApiThumb = /*#__PURE__*/function (_React$Component) {
  _inherits(RecommendedApiThumb, _React$Component);

  var _super = _createSuper(RecommendedApiThumb);
  ...
  function RecommendedApiThumb(props) {
    ...
    _classCallCheck(this, RecommendedApiThumb);
  ...
  _createClass(RecommendedApiThumb, [{
    ...
    value: function render() {
      ...
      var path = this.getPathPrefix(); // const detailsLink = path + this.props.api.id;
      ...
      }, /*#__PURE__*/_react["default"].createElement(_CardMedia["default"], null, /*#__PURE__*/_react["default"].createElement(_reactRouterDom.Link, {
        to: detailsLink,
...
RecommendedApiThumb.contextType = _ApiContext.ApiContext;
