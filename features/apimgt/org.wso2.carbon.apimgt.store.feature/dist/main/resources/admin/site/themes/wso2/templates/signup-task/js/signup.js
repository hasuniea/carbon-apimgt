...
$(document).ready(function () {
  ...
  $('#signup-tasks').datatables_extended({
    "fnDrawCallback": function fnDrawCallback() {
      if (this.fnSettings().fnRecordsDisplay() <= $("#signup-tasks_length option:selected").val() || $("#signup-tasks option:selected").val() == -1) $('#signup-tasks_paginate').hide();else $('#signup-tasks_paginate').show();
    },
