 ...
 */
var Wsdl = /*#__PURE__*/function (_Resource) {
  _inherits(Wsdl, _Resource);

  var _super = _createSuper(Wsdl);
  ...
  function Wsdl() {
    ...
    if (client == null) {
      _this.apiClient = new _APIClientFactory["default"]().getAPIClient(_Utils["default"].getCurrentEnvironment()).client;
    } else {
      _this.apiClient = client;
    }
  ...
  _createClass(Wsdl, [{
    key: "downloadWSDLForEnvironment",
    value: function downloadWSDLForEnvironment(apiId) {
      var environmentName = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      return this.apiClient.then(function (client) {
