...
function addCustomAttribute(element, count) {
  var elementId = element.attr('id');
  element.parent().append('<tr id="attribute' + count + '">' + '<td><div class="clear"></div></td>' + '<td><input type="text" id="attributeName' + count + '" name="attributeName' + count + '" placeholder="' + i18n.t('Attribute Name') + '"/></td>' + '<td><input type="text" id="attributeValue' + count + '" name="attributeValue' + count + '" placeholder="' + i18n.t('Value') + '"/></td>' + '<td class="delete_resource_td"><a  id="attributeDelete' + count + '"  href="javascript:removeCustomAttribute(' + count + ')"><i class="icon-trash"></i></a></td>' + '</tr>');
}

function addCustomAttributeInitially(element, count, name, value) {
  var elementId = element.attr('id');
  element.parent().append('<tr id="attribute' + count + '">' + '<td><div class="clear"></div></td>' + '<td><input type="text" id="attributeName' + count + '" name="attributeName' + count + '" readonly/></td>' + '<td><input type="text" id="attributeValue' + count + '" name="attributeValue' + count + '" readonly/></td>' + '<td class="delete_resource_td "><a  id="attributeDelete' + count + '" href="javascript:removeCustomAttribute(' + count + ');"><i class="icon-trash"></i></a></td>' + '</tr>');
