...
var CommentReplyUnwrapped = (0, _testUtils.unwrap)(_CommentReply["default"]);
var comment, reply;
/**
...
beforeEach(function () {
  wrapper = shallow( /*#__PURE__*/React.createElement(CommentReplyUnwrapped, props));
});
describe('<CommentReply /> rendering', function () {
  ...
  it('should not render a <CommentReply /> component because replies cannot have replies', function () {
