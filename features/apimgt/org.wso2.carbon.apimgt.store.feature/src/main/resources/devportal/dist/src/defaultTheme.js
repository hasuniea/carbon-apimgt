...
var DefaultConfigurations = {
  ...
  palette: {
    primary: {
      ...
      main: '#006e9c' // dark: will be calculated from palette.primary.main,
  ...
  custom: {
    ...
    backgroundImage: '',
    // Add a watermark background to the content area of the page. Example ( '/devportal/site/public/images/back-light.png')
    defaultApiView: 'grid',
    // Sets the default view for the api listing page ( Other values available = 'list' )
    page: {
      style: 'fluid',
      // Set the page style ( Other values available 'fixed', 'fluid')
      width: 1240,
      // This value is effected only when the page.style = 'fixed'
      emptyAreadBackground: '#1e2129',
      // This value is effected only when the page.style = 'fixed' and window size is greater than page.width
      border: 'none' // It can be something like 'solid 1px #cccccc' for fixed layouts

    },
    appBar: {
      logo: '/site/public/images/logo.svg',
      // You can set the url to an external image also ( ex: https://dummyimage.com/208x19/66aad1/ffffff&text=testlogo)
      logoHeight: 19,
      logoWidth: 208,
      background: '#0fa2db',
    ...
    leftMenu: {
      ...
      // Sets the position of the left menu ( 'horizontal', 'vertical-left', 'vertical-right')
      style: 'icon left',
    ...
    infoBar: {
      ...
      showThumbnail: true,
      starColor: '#f6bf21',
      // By default the opasite color of infoBar.background is derived. From here you can override it.
      sliderBackground: '#ffffff',
      iconOddColor: '#347eff',
      iconEvenColor: '#89b4ff',
      listGridSelectedColor: '#347eff',
      // Defines color of the selected icon ( grid/ list ) view of the api listing page
    ...
    thumbnail: {
      ...
      // put false to render the system generated and user provided image.
    ...
    tagWise: {
      active: false,
      style: 'fixed-left',
      // If 'page' it will show a different page. Else if 'fixed-left' will show a fixed menu with all the group tags on the left.
      thumbnail: {
        // These params will be applyed only if the style is 'page'
        width: 150,
    ...
    tagCloud: {
      active: true,
      colorOptions: {
        // This is the Options object passed to TagCloud component of https://www.npmjs.com/package/react-tagcloud
        luminosity: 'dark',
        hue: 'blue'
      },
      leftMenu: {
        // These params will be applyed only if the style is 'fixed-left'
        width: 200,
    ...
    apiDetailPages: {
      ...
      showSdks: true,
      onlyShowSdks: [],
      // You can put an array of strings to enable only a given set of sdks. Leave empty to show all. ex: ['java','javascript']
    ...
    banner: {
      active: false,
      // make it true to display a banner image
      style: 'text',
      // 'can take 'image' or 'text'. If text it will display the 'banner.text' value else it will display the 'banner.image' value.
    ...
    footer: {
      ...
      footerHTML: '',
      text: '',
      // Leave empty to show the default WSO2 Text. Provide custom text to display your own thing.
      background: '#000',
      color: '#fff',
      height: 50
    },
...
var _default = DefaultConfigurations;
