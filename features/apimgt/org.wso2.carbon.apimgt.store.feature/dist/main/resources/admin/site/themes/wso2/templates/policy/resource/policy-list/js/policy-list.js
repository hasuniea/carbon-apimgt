...
var deleteAPIPolicy = function deleteAPIPolicy(policyObject) {
...
$(function () {
  ...
  $('#api-policy').datatables_extended({
    "fnDrawCallback": function fnDrawCallback() {
      if (this.fnSettings().fnRecordsDisplay() <= $("#api-policy_length option:selected").val() || $("#api-policy_length option:selected").val() == -1) $('#api-policy_paginate').hide();else $('#api-policy_paginate').show();
    },
