...
(function ($) {
  ...
  */
  ...
  $.fn.ajaxSubmit = function (options) {
    ...
    log("fileAPI :" + fileAPI);
    var shouldUseFrame = (hasFileInputs || multipart) && !fileAPI; // options.iframe allows user to force iframe mode
    ...
    return this; // XMLHttpRequest Level 2 file uploads (big hat tip to francois2metz)
