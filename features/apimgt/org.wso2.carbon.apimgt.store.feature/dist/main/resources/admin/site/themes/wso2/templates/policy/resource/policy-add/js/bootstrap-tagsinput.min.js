  ...
  b.prototype = {
    ...
    add: function add(b, c) {
      ...
      if (!(d.options.maxTags && d.itemsArray.length >= d.options.maxTags || b !== !1 && !b)) {
        if ("object" == _typeof(b) && !d.objectItems) throw "Can't add objects when itemValue option is not set";
    ...
    remove: function remove(b, c) {
      var d = this;
      d.objectItems && (b = "object" == _typeof(b) ? a.grep(d.itemsArray, function (a) {
        ...
        return a(this).data("item") === b;
      }).remove(), d.itemsArray.splice(a.inArray(b, d.itemsArray), 1)), c || d.pushVal(), d.options.maxTags > d.itemsArray.length && d.$container.removeClass("bootstrap-tagsinput-max"), d.$element.trigger(a.Event("itemRemoved", {
        item: b
      }));
    },
